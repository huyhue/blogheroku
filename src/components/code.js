              ...
              <div className="col-md-8">
                <div className="tab-content">
                  ...
                  <div className="tab-pane active fade show m-4" id="tab-4">
                    ...
                    <ul style={{ listStyleType: 'circle' }}>
                      <li><a href="http://www.kieutrongkhanh.net/">Knowledge add (Blog kieutrongkhanh)</a></li>
                      <li><a href="https://drive.google.com/drive/folders/1lyW4OrNPk1or-GmfdzIRUB_q-rgg9wmA">Download software</a></li>
                      <li><a href="https://www.youtube.com/playlist?list=PLn9lhDYvf_3Hz9GwWrYh7b99QOuQZbfz8">Learn youtube</a></li>
                      <li><a href="https://github.com/huyhue/Java-Web">Source code</a></li>
                      <li><a href /></li>
                    </ul>
                    ...
                    <ul style={{ listStyleType: 'circle' }}>
                      <li><a href="https://drive.google.com/drive/folders/1vEivAOH6HOMPk8QS_YxzypW82R9cm9O1?usp=sharing">Document</a></li>
                      <li><a href="https://www.tudienabc.com/chuyen-doi-han-tu-sang-romaji">Chuyen doi kanji</a></li>
                      <li><a href /></li>
                      <li><a href /></li>
                      <li><a href /></li>
                    </ul>
                    ...
                    <ul style={{ listStyleType: 'circle' }}>
                      <li><a href="https://drive.google.com/drive/folders/1JVMVrzY4s4uFPRuG58OpYB291lpq_jFE?usp=sharing">Title</a></li>
                      <li><a href="https://drive.google.com/drive/folders/1XtG0FuIPzgKSGxQOha11RBaxCKijZGfc?fbclid=IwAR0zvRr4ysJ02cpCvsA9MYWNuyuq8YfrtOGn0J3F8fPi6ftPqQvnpnaReLM">Solution 1</a></li>
                      <li><a href="https://drive.google.com/drive/folders/187BuVY15mA0JEYZCYeKl0CABM6rC2ibl?fbclid=IwAR2rRj2waYp-GvqyC_NsE2aig44X1-7byArRcuIjJLSR83aRIUyGKApMx18">Solution 2</a></li>
                      <li><a href="https://github.com/huyhue/labJavaDesktop">My Solution</a></li>
                    </ul>
                  </div>
